...
def check_for_winners(bingo_boards : list) -> list:
    """
    Checks for bingo winners amongst the boards, and, if it/they exist(s), 
    returns the winning board. Else returns an empty list.
    """
    winning_boards = []
    for board in bingo_boards:
        for row in board:
