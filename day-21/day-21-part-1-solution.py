...
def main():
    ...
    _, _, ingredients_without_allergens = match_allergens(ingredients=ingredients,
                                                          allergens=allergens)

    # the answer to the puzzle is the number of times each of these allergens occur
    answer = len(ingredients_without_allergens)
